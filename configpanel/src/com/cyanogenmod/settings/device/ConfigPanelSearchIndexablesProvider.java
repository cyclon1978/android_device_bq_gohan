...
public class ConfigPanelSearchIndexablesProvider extends SearchIndexablesProvider {
    ...
    public static final int SEARCH_IDX_ADVANCED_SETTINGS_PANEL = 0;

    private static SearchIndexableResource[] INDEXABLE_RES = new SearchIndexableResource[]{
            new SearchIndexableResource(1, R.xml.advanced_settings_panel,
                    AdvancedSettings.class.getName(),
                    R.drawable.ic_advanced_settings),
    };
    ...
    public Cursor queryXmlResources(String[] projection) {
        ...
        if (Startup.hasAdvancedSettings() /* show advanced settings panel */) {
            cursor.addRow(generateResourceRef(INDEXABLE_RES[SEARCH_IDX_ADVANCED_SETTINGS_PANEL]));
        }
        return cursor;
    }
