...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    public SeekBarPreference(Context context, AttributeSet attrs, int defStyle) {
		...
		for (int n = 0; n < attrs.getAttributeCount(); n++) {
            Log.w(TAG, "attr " + attrs.getAttributeName(n) + " value " + attrs.getAttributeValue(n));
		}
		
        setMax(attrs.getAttributeIntValue(androidns, "max", 100));
        setBase(attrs.getAttributeIntValue(autons, "base", 0));
    ...
    protected void onBindView(View view) {
        ...
        seekBar.setMax(mMax-mBase);
        seekBar.setProgress(mProgress-mBase);
    ...
    void syncProgress(SeekBar seekBar) {
        int progress = seekBar.getProgress() + mBase;
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        if (seekBar.getProgress() != (mProgress-mBase)) {
            syncProgress(seekBar);
        }
    }
