                     ...
                     hw_device_t **device)
{
	...
	// HACK for Device gohan
	platform_set_snd_device_backend(SND_DEVICE_OUT_SPEAKER, "smpa"); // 2, match
	platform_set_snd_device_backend(SND_DEVICE_OUT_VOICE_SPEAKER, "smpa"); // 16, match
	platform_set_snd_device_backend(SND_DEVICE_OUT_RING_SPEAKER, "smpa"); // 18 -> should be SND_DEVICE_OUT_RING_SPEAKER
	platform_set_snd_device_backend(SND_DEVICE_OUT_SPEAKER_AND_HEADPHONES, "spkhph-smpa"); // 11, match
	platform_set_snd_device_acdb_id(SND_DEVICE_IN_HANDSET_DMIC_AEC_NS, 257); // 58 -> should be SND_DEVICE_IN_HANDSET_DMIC_AEC_NS | set value overwrites 111 in platform.c
